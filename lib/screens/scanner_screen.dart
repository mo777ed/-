...
class _ScannerScreenState extends State<ScannerScreen> {
  ...
  String _errorMessage(MobileScannerException error) {
    final buffer = StringBuffer(error.errorCode.name);
    try {
      final dynamic details = (error as dynamic).errorDetails;
    ...
    final base = error.errorCode == MobileScannerErrorCode.permissionDenied
        ...
        : 'تعذّر تشغيل الكاميرا على هذا الجهاز. يمكنك إدخال الباركود يدويًا.';
    return '$base\n\n(${buffer.toString()})';
  }
